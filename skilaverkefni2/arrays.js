...
console.log(JSON.stringify(removeFirstThreeElements([1, 2, 3, 4])));
console.log(JSON.stringify(removeFirstThreeElements([5, 4, 3, 2, 1, 0])));
console.log(JSON.stringify(removeFirstThreeElements([99, 1, 1])));
...
console.log(JSON.stringify(removeLastNElements([1, 2, 3, 4, 5], 2)));
console.log(JSON.stringify(removeLastNElements([1, 2, 3], 6)));
console.log(JSON.stringify(removeLastNElements([1, 2, 3, 4, 5, 6, 7, 8], 3)));
...
console.log(countNumberOfElements([1, 2, 3, 4]));
...
console.log(areAllEqual([true, true, true]));
...
console.log(JSON.stringify(mergeAllArrays([1, 2, 3], [4, 5, 6])));
console.log(JSON.stringify(mergeAllArrays(['a', 'b', 'c'], [4, 5, 6])));
console.log(JSON.stringify(mergeAllArrays([true, true], [1, 2], ['a', 'b'])));
