...
console.log(JSON.stringify(extractKeysFromObject({ a: 1, b: 2, c: 3 })));
console.log(JSON.stringify(extractKeysFromObject({ j: 9, i: 2, x: 3, z: 4 })));
console.log(JSON.stringify(extractKeysFromObject({ w: 15, x: 22, y: 13 })));
...
const getNestedProperty = (obj) => {
    if (obj.hasOwnProperty('a') && typeof obj.a === 'object') {
        return obj.a.hasOwnProperty('b') ? obj.a.b : undefined;
    } else {
        return undefined;
    }
...
console.log(getNestedProperty(ob1));
console.log(getNestedProperty(ob2));
console.log(getNestedProperty(ob3));
console.log(getNestedProperty(ob4));
...
console.log(removePropertyB(myObject1));
console.log(removePropertyB(myObject2));
console.log(removePropertyB(myObject3));
...
console.log(multipyAllValuesByB({ j: 9, i: 2, x: 3, z: 4 }, 10, 3));
console.log(multipyAllValuesByB({ w: 15, x: 22, y: 13 }, 6, 3));
